...
public class DemoResourceTest extends JerseySpringTest {
	...
	public void resourceIsSingleton() {
		...
		assertEquals(target("demo/hash-code").request().get(String.class), target("demo/hash-code").request().get(String.class));
	}
	...
	public void template4view() {
		...
		// 指定 accept: text/html
		Response res = target(path).request(MediaType.TEXT_HTML).get();
		...
		res = target(path).request("text/html,application/xhtml+xml,application/xml;q=0.9,image/webp,*/*;q=0.8").get();
		assertEquals(Status.OK.getStatusCode(), res.getStatus());
		assertEquals(MediaType.TEXT_HTML_TYPE, res.getMediaType());
		assertEquals(tpl, res.readEntity(String.class));
	...
	public void data4view() {
		...
		Response res = target("demo").request(MediaType.APPLICATION_JSON).get();
		assertEquals(Status.OK.getStatusCode(), res.getStatus());
		...
		res = target("demo").request("text/html;q=0.4,application/json;q=0.5").get();
		assertEquals(Status.OK.getStatusCode(), res.getStatus());
		assertEquals(MediaType.APPLICATION_JSON_TYPE, res.getMediaType());
		assertEquals("[]", res.readEntity(String.class));
	}
	...
	public void template4form() {
		...
		// 指定 accept: text/html
		res = target(path).request(MediaType.TEXT_HTML).get();
		assertEquals(Status.OK.getStatusCode(), res.getStatus());
		assertEquals(MediaType.TEXT_HTML_TYPE, res.getMediaType());
		assertEquals(tpl, res.readEntity(String.class));
	...
	public void data4form_exists() {
		...
		// 指定 accept: application/json
		Response res = target(path).request(MediaType.APPLICATION_JSON).get();
		assertEquals(Status.OK.getStatusCode(), res.getStatus());
		assertEquals(MediaType.APPLICATION_JSON_TYPE, res.getMediaType());
	...
	public void create() {
		...
		Response res = target("demo").request().post(Entity.form(form));
	...
	public void update() {
		...
		Response res = target("demo/" + origin.getId()).request().put(Entity.form(form));
		assertEquals(Status.OK.getStatusCode(), res.getStatus());
		assertEquals(MediaType.TEXT_PLAIN_TYPE, res.getMediaType());
	...
	public void delete() {
		...
		// 删除创建的对象
		Response res = target("demo/" + origin.getId()).request().delete();
		assertEquals(Status.OK.getStatusCode(), res.getStatus());
		assertEquals(MediaType.TEXT_PLAIN_TYPE, res.getMediaType());
		assertEquals("成功删除 1 条信息！", res.readEntity(String.class));

		// 重复删除
		res = target("demo/" + origin.getId()).request().delete();
		assertEquals(Status.OK.getStatusCode(), res.getStatus());
		assertEquals(MediaType.TEXT_PLAIN_TYPE, res.getMediaType());
	...
	public void batchDelete() {
		...
		// 删除创建的对象
		Response res = target(path).request().delete();
		assertEquals(Status.OK.getStatusCode(), res.getStatus());
		assertEquals(MediaType.TEXT_PLAIN_TYPE, res.getMediaType());
		assertEquals("成功删除 2 条信息！", res.readEntity(String.class));

		// 重复删除
		res = target(path).request().delete();
		assertEquals(Status.OK.getStatusCode(), res.getStatus());
		assertEquals(MediaType.TEXT_PLAIN_TYPE, res.getMediaType());
		assertEquals("成功删除 0 条信息！", res.readEntity(String.class));
	}
	...
	@Test
	public void clean() {
		Response res = target("demo").request().delete();
		assertEquals(Status.OK.getStatusCode(), res.getStatus());
		assertEquals(MediaType.TEXT_PLAIN_TYPE, res.getMediaType());
	...
	public void download2txt() throws IOException {
		Response res = target("demo/export").request(MediaType.APPLICATION_OCTET_STREAM).get();
		assertEquals(Status.OK.getStatusCode(), res.getStatus());
	...
	public void download2excel() throws IOException {
		...
		Response res = target("demo/export").request(mediaType).get();
		assertEquals(Status.OK.getStatusCode(), res.getStatus());
